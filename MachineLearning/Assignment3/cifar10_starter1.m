function cifar10_starter1()
    ...
    net.layers{end+1} = struct('type', 'convolution',...
        'params', struct('weights', 0.1*randn(5,5,32,32)/sqrt(5*5*32/2), 'biases', zeros(32,1)),...
        'padding', [2 2]);
    
    net.layers{end+1} = struct('type', 'relu');
    
    net.layers{end+1} = struct('type', 'fully_connected',...
        'params', struct('weights', randn(10,8192)/sqrt(8192/2), 'biases', zeros(10,1)));
    ...
    save('models/cifar10_baseline1.mat', 'net');
