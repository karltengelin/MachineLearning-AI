...
rewards = struct('default', 0, 'apple', 10, 'death', -1000); % 0 10 -1000 Reward signal                                                        from beginning: 0 1 -1
gamm    = 0.95;  %0.95% Discount factor in Q-learning                                                                              from beginning: 0.9
alph    = 0.01; % 0.01 % Learning rate in Q-learning (automatically set to zero during testing)                                     from beginning: 0.01
eps     = 0.001; % 0.001 % Random action selection probability in epsilon-greedy Q-learning (automatically set to zero during testing)from beginning: 0.01
